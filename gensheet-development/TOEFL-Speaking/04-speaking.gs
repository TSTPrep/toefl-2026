// TOEFL 2026 - Speaking Section - 2-in-1 Passage Generator
// This script generates passages and questions for two different TOEFL Speaking exercise types.

// --- GLOBAL CONFIGURATION ---
// Maps the short exercise names to their configuration details.
const EXERCISES = {
  'ListenAndRepeat': {
    sheetName: 'ListenAndRepeat',
    configColumn: 'B'
  },
  'Interview': {
    sheetName: 'Interview',
...
function generateBatch_ListenAndRepeat() { generatePassageBatch('ListenAndRepeat'); }
function startBatchProcess_ListenAndRepeat() { startBatchRun('ListenAndRepeat'); }
function startEditSheetConversions_ListenAndRepeat() { startEditSheetConversions('ListenAndRepeat'); }
function deleteEditingSheets_ListenAndRepeat() { deleteEditingSheets('ListenAndRepeat'); }

function generateBatch_Interview() { generatePassageBatch('Interview'); }
function startBatchProcess_Interview() { startBatchRun('Interview'); }
function startEditSheetConversions_Interview() { startEditSheetConversions('Interview'); }
function deleteEditingSheets_Interview() { deleteEditingSheets('Interview'); }
